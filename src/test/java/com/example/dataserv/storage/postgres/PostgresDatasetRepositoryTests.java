...
class PostgresDatasetRepositoryTests {
    ...
    @Test
    void copyDataStoresValuesUsingCorrectPostgresTypes()
            throws Exception {
    ...
    @Test
    void copyDataFailsWhenValueDoesNotMatchColumnType()
            throws Exception {
    ...
    @Test
    void findByIdReturnsDatasetAndReadsSchemaFromPhysicalTable()
            throws Exception {
        ...
        assertEquals(
                2,
                found.getSchema().getColumns().size()
        );

        assertEquals(
                "name",
                found.getSchema().getColumns().get(0).getName()
        );

        assertEquals(
                DataType.STRING,
                found.getSchema().getColumns().get(0).getType()
        );

        assertEquals(
                "age",
                found.getSchema().getColumns().get(1).getName()
        );

        assertEquals(
                DataType.INTEGER,
                found.getSchema().getColumns().get(1).getType()
        );
    }

    @Test
    void findByIdReturnsPersistedCreatedAtAndLiveRowCount()
            throws Exception {
    ...
    @Test
    void deleteByIdRemovesMetadataAndDynamicTable()
            throws Exception {
        ...
        Integer tableCountBeforeDelete =
    ...
    @Test
    void queryReturnsAllRowsWhenThereAreNoFilters()
            throws Exception {

        UUID id = createDatasetWithRows();

        List<DataRow> results =
                repository.query(id, List.of());

        assertEquals(3, results.size());

        assertEquals(
                "Alice",
                results.get(0).getValues().get("name")
        );

        assertEquals(
                25,
                results.get(0).getValues().get("age")
        );

        assertEquals(
                "Bob",
                results.get(1).getValues().get("name")
        );

        assertEquals(
                30,
                results.get(1).getValues().get("age")
        );

        assertEquals(
                "Charlie",
                results.get(2).getValues().get("name")
        );

        assertEquals(
                35,
                results.get(2).getValues().get("age")
        );
    }

    @Test
    void queryFiltersByEquality()
            throws Exception {
    ...
    @Test
    void queryFiltersIntegersUsingGreaterThan()
            throws Exception {
    ...
    @Test
    void queryFiltersIntegersUsingLessThan()
            throws Exception {
    ...
    @Test
    void querySupportsMultipleFilters()
            throws Exception {
    ...
    @Test
    void queryReturnsEmptyListWhenNoRowsMatch()
            throws Exception {
    ...
    @Test
    void queryFiltersBooleanValues()
            throws Exception {
    ...
    private UUID createDatasetWithRows()
            throws Exception {
    ...
    @Test
    void findAllReturnsAllDatasetsWithTheirSchemas()
            throws Exception {
        ...
        try {
            ...
            assertEquals(
                    dataset1.getSchema().getColumns(),
                    found1.getSchema().getColumns()
            );

            assertEquals("dataset-two", found2.getName());
            assertEquals(
                    dataset2.getSchema().getColumns(),
                    found2.getSchema().getColumns()
            );
